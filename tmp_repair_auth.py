...
files = {
    "backend/src/routes/authRoutes.js": '''import { Router } from "express";
...
''',
    "backend/src/controllers/authController.js": '''import { registerUser, loginUser, loginWithGoogle, registerWithGoogle, updateUserSelf, AuthError } from "../services/authService.js";
